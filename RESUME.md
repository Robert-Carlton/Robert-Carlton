...
[LinkedIn](https://www.linkedin.com/in/RobertCarlton) · [GitHub](https://github.com/Robert-Carlton) · Chicago, IL · RMCMailbox@yahoo.com

*This is my full professional background. If you received a résumé tailored to a specific role, this is the fuller picture behind it — some sections here are condensed or reordered in role-specific versions.*

Global Marketing and Communications Executive with expertise in maximizing revenue, growing share, enhancing brands, and driving strategic repositioning/turnarounds for leading companies in the private, non-profit, and governmental sectors — including Intel, McDonald's, Owens-Illinois, and Metra. Extensive strategic corporate communications experience, including high-stakes crisis, reputation, and policy communications, messaging and content strategy, media relations, and P.R. Deep expertise in rebranding, brand integrations, launching new brands, and driving B2B/B2C growth and revenue.

## Core Competencies

- Trusted advisor and subject matter expert on complex, high-stakes communications initiatives, including crisis, reputation, and policy communications — with a track record of rapid, first-attempt-right execution under tight timelines and direct C-suite/executive engagement.
- Range of crisis and risk experience spanning live security operations (NATO Summit, coordinating with the FBI and U.S. Secret Service), physical-safety incidents, internal governance/accountability reviews, industry-wide reputational attacks, legislative/policy threats, and emerging regulatory risk-spotting.
- Deep strategic marketing experience spanning the full funnel — brand strategy, acquisition marketing, retention/lifecycle marketing and customer lifetime value (LTV) economics, demand generation, campaign development & execution, messaging, product marketing, GTM strategy, and market research.
- Extensive strategic corporate communications expertise, including messaging & positioning, executive communications, media relations & P.R., crisis communications, stakeholder engagement, issues/reputation management, policy/legislative advocacy, and financial communications.
- Substantial analytics and applied AI/data science expertise, including churn modeling with data imputation techniques, stock price prediction using ensemble methods, NLP-based signal extraction leveraging LLMs, generative AI and prompt engineering, discrete-event simulation integrating computer-vision tracking with machine learning frameworks (PyTorch), and knowledge distillation of a large language model into a lightweight, production-viable model. Also includes building and publicly releasing an agentic AI tool for communications professionals.
- Experience leading marketing & communications turnarounds and digital transformations across telecom and transit organizations.
- Builder of diverse, high-performance teams that solve thorny problems and deliver outstanding results across industries and company cultures.

## Selected AI & Analytics Projects

Independent and graduate-level (Georgia Tech M.S. Analytics) applied projects in machine learning, statistical modeling, and generative AI. Full write-ups and code linked below.

- **[Telco Customer Churn Prediction](https://github.com/Robert-Carlton/Telco-Churn-Reduction)** — Built and evaluated six classification models on a 7,043-customer telecom dataset to predict churn, comparing three missing-data imputation methods and multiple variable-selection approaches; best model (Random Forest) reached 76.81% accuracy. Quantified how model lift translates into retained customer lifetime value.
- **[Knowledge Distillation for Job-Requirement Extraction](https://github.com/Robert-Carlton/Signals-Extraction)** — Georgia Tech Summer Practicum (3-person team) for an AI hiring-tech startup. Built a pipeline extracting nuanced education/experience requirements from 1.2M+ job postings, combined LLM-generated and client-parser labels into a hybrid label set outperforming either alone, and distilled a large labeling LLM into a lightweight fine-tuned model (99% Hamming accuracy, 19ms inference).
- **[Drive-Thru Simulation Study for Roadway Safety](https://github.com/Robert-Carlton/Drive-through-Simulation-Study)** — Modeled drive-thru queue overflow onto public roadways via a discrete-event simulation (ARENA), validated against real-world video data, showing incremental staffing could cut roadway-safety incidents over 95%.
- **[Market Maven: Stock Price Prediction & Visualization Tool](https://github.com/Robert-Carlton/Stock-Price-Prediction)** — Georgia Tech team project building a stock-price forecasting/visualization tool integrating technical, fundamental, social, and PESTEL data; led data integration and the interactive visualization interface.
- **[PR Tools: The AI Built for Comms Pros](https://github.com/Robert-Carlton/AI-Built-for-Comms-Pros)** — Independently designed and released an agentic AI plugin encoding 25+ years of PR/media-relations expertise into an automated press-pitching workflow, from news-value assessment through pitch drafting and coverage reporting.

## Professional Experience

### Managing Director, EVP Marketing & Communications — Muddy Gecko Marketing Agency, Chicago, IL — 2015–Present

Boutique firm of independent, senior-level marketing and communications experts, engaged for expertise, speed, and precision rather than staff augmentation. Provide strategic counsel and hands-on execution — from serving as a client's full outsourced marketing/communications function to advising at the board/C-suite level during confidential, high-stakes transitions.

Client engagements have included (client identities generalized below to protect confidentiality):

- **A venture-backed sensor technology company** (outsourced Marketing & Communications function) — Built and executed the company's communications strategy — media relations, trade/business press outreach, analyst relations, and technical content development — shaping the company and product narrative ahead of its sale to a larger industry acquirer for approximately $500M.
- **A publicly listed digital signal processing chip/software provider** (M&A-phase positioning & communications advisor) — Advised on product positioning and messaging targeting B2B, technology, and financial-analyst audiences, requiring SEC-related due-diligence discipline across all communications during confidential merger discussions. The company was subsequently acquired in an all-cash transaction valued at approximately $549M.
- **A global semiconductor company's storage/memory division** (strategic business advisor) — Engaged for multi-phase strategic advisory work evaluating the division's path forward: enhanced-marketing repositioning versus divestiture. This analysis preceded a multibillion-dollar divestiture of the business the following year.
- **A global technology company** (outsourced marketing & communications leadership, three-year engagement) — Directed media relations, analyst relations, and content strategy — building the narrative and media presence across B2B, B2C, and B2G audiences — through major strategic pivots as the company evolved from digital authentication toward digital identity/verification. Among the firm's most successful engagements.
- **A venture-backed network technology company** (product launch & GTM strategy advisor) — Guided go-to-market strategy, product launch positioning and messaging, and analyst/media outreach for a major architectural advancement in tier-1 network management. The company was later acquired by a strategic buyer.
- **A semiconductor/neural-processor technology startup** (product marketing & communications advisor) — Advised on product marketing strategy, positioning, and messaging; guided media/PR outreach, social media, analyst relations, and event strategy.
- **A venture-backed technology company** (positioning & internal/external communications advisor) — Advised on internal and external messaging and positioning strategy through a transition from early-stage startup to a viable commercial platform.
- **A global enterprise software company** (CMO restructuring advisor) — Guided a team evaluating how the company's new CMO could restructure the marketing organization for greater effectiveness.
- **A financial content/fintech-adjacent company** (influencer strategy & risk advisory) — Advised on development of an influencer outreach program targeting "finfluencers," an emerging category of financial content creators operating in a legally unsettled regulatory space, including identification of material legal and compliance risks.
